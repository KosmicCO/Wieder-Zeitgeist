...
public class VColor {
    ...
    /**
     * Constructs a color from a vector of values, resizing the vector if it is not the appropriate size.
    ...
    public VColor mix(VColor top) {
        if(top.a() + EPSILON > 1) return top;
        if(top.a() < EPSILON) return this;
